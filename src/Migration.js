...
const tokens = [
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_OPEC_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_OPEC_IOU"),
    cap: MaxUint256,
    bonus: 0,
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "GMT_USDG_OPEC_IOU"),
  ...
  },
  {
    ...
    iouToken: getContract(CHAIN_ID, "XGMT_USDG_OPEC_IOU"),
