...
import opecArbitrum from "../../img/ic_gmx_arbitrum.svg";
import opecAvax from "../../img/ic_gmx_avax.svg";
import ohmArbitrum from "../../img/ic_olympus_arbitrum.svg";
import arbitrum16Icon from "../../img/ic_arbitrum_16.svg";
import avalanche16Icon from "../../img/ic_avalanche_16.svg";
import Button from "../../components/Common/Button";

export default function BuyOPEC() {
  ...
  return (
    <div className="BuyOPECXPC default-container page-layout">
      <div className="BuyOPECXPC-container">
        {chainId === ARBITRUM && (
          <div className="section-title-block">
            <div className="section-title-content">
              <div className="Page-title">Buy / Transfer ETH</div>
              <div className="Page-description">
                ETH is needed on Arbitrum to purchase OPEC.
                <br />
                To purchase OPEC on{" "}
        ...
        {chainId === AVALANCHE && (
          <div className="section-title-block">
            <div className="section-title-content">
              ...
              <div className="Page-description">
                Avax is needed on Avalanche to purchase OPEC.
                <br />
                To purchase OPEC on{" "}
            ...
            <div className="buy-card">
              ...
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuyOPECXPC-description better-rates-description">
        ...
        {chainId === ARBITRUM && (
          <div className="BuyOPECXPC-panel">
            ...
            <div className="buy-card">
              <div className="section-title-content">
                <div className="card-title">Buy OPEC Bonds</div>
              </div>
              <div className="App-card no-height">
                <div className="App-card-content no-title">
                  <div className="BuyOPECXPC-description">
