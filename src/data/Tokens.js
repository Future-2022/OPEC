...
const TOKENS = {
  ...
  43113: [
    ...
    },
    {
      name: "Bitcoin (WBTC.e)",
      symbol: "BTC",
      address: "0x0Eb2697C95ab4A3CEAC6C423c098924Ca3668F7B",
      decimals: 8,
      isShortable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/7598/thumb/wrapped_bitcoin_wbtc.png?1548822744",
    },
    {
      name: "USD Coin (USDC.e)",
      symbol: "USDC.e",
      address: "0x0f9cd60Bb1EC016B6f2C689c48231198Bd78e3Cf",
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
    },
...
const ADDITIONAL_TOKENS = {
  42161: [
    {
      name: "OPEC",
      symbol: "OPEC",
      address: getContract(42161, "OPEC"),
      decimals: 18,
    },
    {
      name: "Escrowed OPEC",
      symbol: "esOPEC",
      address: getContract(42161, "ES_OPEC"),
      decimals: 18,
    },
    {
      name: "OPEC LP",
      symbol: "XPC",
      address: getContract(42161, "XPC"),
      decimals: 18,
    },
  ],
  // 43114: [
  ...
  //     name: "OPEC",
  //     symbol: "OPEC",
  //     address: getContract(43114, "OPEC"),
  //     decimals: 18,
  //   },
  //   {
  //     name: "Escrowed OPEC",
  //     symbol: "esOPEC",
  //     address: getContract(43114, "ES_OPEC"),
  //     decimals: 18,
  //   },
  //   {
  //     name: "OPEC LP",
  ...
  43113: [
    {
      name: "OPEC",
      symbol: "OPEC",
      address: getContract(43113, "OPEC"),
      decimals: 18,
    },
    {
      name: "Escrowed OPEC",
      symbol: "esOPEC",
      address: getContract(43113, "ES_OPEC"),
      decimals: 18,
    },
    {
      name: "OPEC LP",
...
const CHAIN_IDS = [56, 97, 42161, 421611, 43113];
